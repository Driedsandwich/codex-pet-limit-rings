...
```bash
(cd dist && shasum -a 256 -c CodexPetLimitRings-v1.0.14-macos-arm64.zip.sha256)
```
...
### Published v1.0.14 Evidence

- Release target: `c53255e47155930b8ebc83f97aa836a9d1b5ebf1`; tree equals the tested PR head.
- [PR #50](https://github.com/Driedsandwich/codex-pet-limit-rings/pull/50) merged; [main CI](https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/35799230479) passed on macOS 15 and 26.
...
- Version/build: `1.0.14 / 23`; arm64, minimum macOS 15.0, ad-hoc signed and not notarized.
- The installed bundle matched the tested package; the separate live diagnostic reported ready app-server and a readable pet frame, with notifications off.
- Fixed-SHA re-download and all artifact gates passed, with synthetic account data for preview/diagnostics. A re-signed ZIP with only its plist minimum OS changed was correctly rejected.

```bash
EXPECTED_MIN_OS=15.0 \
EXPECTED_SHA256=7e4ebe4b43fd9b73ea7668fa5394136736db58b30c95ed633aac09f6bf66bb47 \
  tools/smoke-release-artifact.sh 1.0.14
```

### Published v1.0.13 Evidence

- Release commit and target: `acf93391a925999e28df7888ece97e65fc26e92a`.
- Tag and Release: [`v1.0.13`](https://github.com/Driedsandwich/codex-pet-limit-rings/releases/tag/v1.0.13).
- Release ZIP SHA-256: `dd0ef8c31df8af0c5e3dbc2b5fcf614cfc4942f8191aec3f164eabbbc8c76a78`.
...
- Merge-commit CI passed on macOS 15 and macOS 26 (`https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/33234562005`).
- The installed and published binaries matched, and the live 163-by-163 ring panel center matched the configured 80-by-86.667 pet canvas center within macOS window-coordinate rounding.
...
### Published v1.0.12 Evidence

- Release commit and target: `08754b592841bf0bfccd885fb688e8deec4342e9`.
- Tag and Release: [`v1.0.12`](https://github.com/Driedsandwich/codex-pet-limit-rings/releases/tag/v1.0.12).
- Release ZIP SHA-256: `bd5d5142887fd9d475a0b0f6a5d66be9c36c5f666b69239f42e56ade29880392`.
- Packaged architecture: Apple silicon `arm64`.
- Packaged minimum OS: macOS `15.0` in both `LSMinimumSystemVersion` and the Mach-O build command.
- Signing status: ad-hoc signed and not notarized.
- Merge-commit CI passed on macOS 15 and macOS 26 (`https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/33230792378`).
- The published artifact smoke test passed checksum, archive allowlisting, local-path sanitization, signature, architecture, version, deployment-target, English/Japanese resources, preview execution, and privacy-safe diagnostic checks:

```bash
EXPECTED_MIN_OS=15.0 \
EXPECTED_SHA256=bd5d5142887fd9d475a0b0f6a5d66be9c36c5f666b69239f42e56ade29880392 \
  tools/smoke-release-artifact.sh 1.0.12
```
...
- Release commit and target: `6a95bf462acd4c8acb0cf26d5b2dad273e0a4439`.
- Tag and Release: [`v1.0.10`](https://github.com/Driedsandwich/codex-pet-limit-rings/releases/tag/v1.0.10).
- Release ZIP SHA-256: `ad4c87912b085695eeda10bba6e911b235e1077d11059d6002fb6d1838a0d3df`.
- Packaged architecture: Apple silicon `arm64`.
- Packaged minimum OS: macOS `15.0` in both `LSMinimumSystemVersion` and the Mach-O build command.
- Signing status: ad-hoc signed and not notarized.
- Merge-commit CI passed on macOS 15 and macOS 26 (`https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/30369168881`).
- A 926-second installed-candidate soak retained pet alignment, completed manual refresh, recovered from a forced app-server reconnect, exercised the 120-second watchdog, and ended with current rate-limit and usage data while notifications remained off.
- The published artifact smoke test passed checksum, archive allowlisting, local-path sanitization, signature, architecture, version, deployment-target, English/Japanese resources, preview-execution, and privacy-safe diagnostic checks:
...
### Published v1.0.9 Evidence

- Release commit and target: `a69411f78cfefa77d0ed955524fbb829dbbe3f5f`.
- Tag and Release: [`v1.0.9`](https://github.com/Driedsandwich/codex-pet-limit-rings/releases/tag/v1.0.9).
- Release ZIP SHA-256: `e085c5ee47e9a8ebafbc8cb6d2788d673b26c85ab1b520792bbe5da8b42aa273`.
- Packaged architecture: Apple silicon `arm64`.
- Packaged minimum OS: macOS `15.0` in both `LSMinimumSystemVersion` and the Mach-O build command.
- Signing status: ad-hoc signed and not notarized.
- Merge-commit CI passed on macOS 15 and macOS 26 (`https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/29894494890`).
- Installed-candidate checks covered healthy manual refresh, forced child-process recovery, an overdue watchdog reconnect, notifications off, and privacy-safe diagnostics; unit tests separately cover initialization-stall recovery.
...
- Release commit and target: `96f16fc75c17426c5a752eafa2647ddfed21477c`.
- Tag and Release: [`v1.0.7`](https://github.com/Driedsandwich/codex-pet-limit-rings/releases/tag/v1.0.7).
- Release ZIP SHA-256: `5ea1d303b438c8243bec68f22d475a072085e1c08d7b7548421e04b186a78c0e`.
- Packaged architecture: Apple silicon `arm64`.
- Packaged minimum OS: macOS `15.0` in both `LSMinimumSystemVersion` and the Mach-O build command.
- Signing status: ad-hoc signed and not notarized.
- Merge-commit CI passed on macOS 15 and macOS 26 (`https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/29591638335`).
- Installed-candidate checks covered the full pet-size slider range, including a 319-by-319 ring panel at the maximum setting, plus ring alignment, notifications off, and privacy-safe diagnostics.
- The published artifact smoke test passed checksum, local-path sanitization, signature, architecture, version, deployment-target, English/Japanese resources, preview-execution, and privacy-safe diagnostic checks:
...
### Published v1.0.6 Evidence

- Release commit and target: `5ada6aaf67caa6198908f6a062eca766a2503a61`.
- Tag and Release: [`v1.0.6`](https://github.com/Driedsandwich/codex-pet-limit-rings/releases/tag/v1.0.6).
- Release ZIP SHA-256: `e2d82096c47795ec33b557d6260ed37f4353cd39b210740ee79a7730a8292e3b`.
- Packaged architecture: Apple silicon `arm64`.
- Packaged minimum OS: macOS `15.0` in both `LSMinimumSystemVersion` and the Mach-O build command.
- Signing status: ad-hoc signed and not notarized.
- Merge-commit CI passed on macOS 15 and macOS 26 (`https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/29559887038`).
- Installed-candidate checks covered current ChatGPT pet-surface recovery, official-process binding, ring alignment, notifications off, and privacy-safe diagnostics.
- The published artifact smoke test passed checksum, local-path sanitization, signature, architecture, version, deployment-target, English/Japanese resources, preview-execution, and privacy-safe diagnostic checks:
...
### Published v1.0.5 Evidence

- Release commit and target: `84e8daab1fae9182708067c348d94d8d877cb985`.
- Tag and Release: [`v1.0.5`](https://github.com/Driedsandwich/codex-pet-limit-rings/releases/tag/v1.0.5).
- Release ZIP SHA-256: `eaaa32c870542990429fe2586224c225795f87ebd9ab39259ba8c4c60740e7bb`.
- Packaged architecture: Apple silicon `arm64`.
- Packaged minimum OS: macOS `15.0` in both `LSMinimumSystemVersion` and the Mach-O build command.
- Signing status: ad-hoc signed and not notarized.
- Merge-commit CI passed on macOS 15 and macOS 26 (`https://github.com/Driedsandwich/codex-pet-limit-rings/actions/runs/29374761072`).
- Installed-candidate checks covered the persistent watchdog, a scheduled full sync after more than 120 seconds, reconnect recovery, alignment, notifications off, and privacy-safe diagnostics.
- The published artifact smoke test passed checksum, local-path sanitization, signature, architecture, version, deployment-target, English/Japanese resources, preview-execution, and privacy-safe diagnostic checks:
